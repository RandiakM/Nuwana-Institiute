 ...
 * @author Randika
 */
public class ViewAndDeleteStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Student ID", "First Name", "Last Name", "NIC ", "Telephone No" }));
...
//                            + "WHERE StudentId=?";
    ...
    private void Teacher_Delete_BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Teacher_Delete_BtnActionPerformed
        ...
        String sql1="DELETE FROM users WHERE StudentId=?";
...
//            pst3.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAndDeleteStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
